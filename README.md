...
- API: use the `insightflow-api` primary URL shown by Render, with `/api/health`
- AI analyst: use the `insightflow-ai-analyst` primary URL shown by Render, with `/health`
